        ...
        <div>
            <div className='flex justify-around my-24'>
                <div className='space-y-4 w-[25%]' >
                    ...
                    <p className='w-8/12'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In dictum non tortor quis consectetur.</p>
            ...
            <hr />
            <h1 className='text-center py-5'>Copyright © 2024 Haidezign. All Right Reserved</h1>
        </div>
